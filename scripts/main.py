...
# target_img_path = r"data\img\3-12-009.jpeg"
...
# font = ImageFont.truetype('simsun.ttf', 20)  # 字体设置，Windows系统可以在 "C:\Windows\Fonts" 下查找
# img_PIL = Image.fromarray(target_img[..., ::-1])  # 转成 PIL 格式
...
# cv2.imshow(target_img_path, image)
# cv2.waitKey(0)
