...
def main_loop():
    ...
    print("value:", value * cap.sExposeDesc.fAnalogGainStep)
    ...
    # 设置相机分辨率
    # SetCameraResolution(hCamera, 512, 360, 1920, 1080)
    SetCameraResolution(hCamera, 512, 360, 960, 540)
    # SetCameraResolution(hCamera, 384, 400, 1280, 720)
    ...
    while (cv2.waitKey(1) & 0xFF) != ord('q'):
        ...
        try:
            ...
            # print(FrameHead.iWidth, FrameHead.iHeight)
